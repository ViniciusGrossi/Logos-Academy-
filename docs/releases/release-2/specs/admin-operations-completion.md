...
Nenhuma SR altera regra pedagógica, estado ou tabela; todas são leituras novas ou campos a mais. Implementação via RPCs `service_role` (migration `0053_admin_operations_read_models.sql`: a Release 1 ocupou 0051 e 0052 com o Atlas).
